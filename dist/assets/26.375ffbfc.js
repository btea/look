...
<img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/6/30/17304917f408db00~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<p>\u9898\u5E72\u4E2D\u4E00\u76F4\u5728\u5F3A\u8C03\u201C\u7956\u5148\u7ED3\u70B9\u201D\u3001\u201C\u6811\u7684\u6DF1\u5EA6\u201D\u7B49\u6982\u5FF5\uFF0C\u8FD9\u53EF\u80FD\u4F1A\u8BEF\u5BFC\u4E00\u90E8\u5206\u540C\u5B66\u60C5\u4E0D\u81EA\u7981\u5730\u4EE3\u5165\u201C\u7239\u627E\u513F\u5B50\u201D\u8FD9\u79CD\u601D\u7EF4\u6A21\u5F0F\uFF0C\u7136\u540E\u9677\u5165\u50F5\u5C40\u3002\u5982\u679C\u4F60\u4E0D\u5E78\u4E2D\u62DB\uFF0C\u522B\u5FD8\u4E86\uFF1A</p>
<pre><code class="hljs language-!" lang="!">\u867D\u7136\u7F16\u7801\u7684\u65F6\u5019\u6211\u4EEC\u5B9E\u73B0\u7684\u786E\u5B9E\u662F\u201C\u7239\u627E\u513F\u5B50\u201D\uFF0C\u4F46\u662F\u5728\u89C4\u5219\u6478\u7D22\u9636\u6BB5\uFF0C\u201C\u513F\u5B50\u627E\u7239\u201D\u8FD9\u79CD\u601D\u7EF4\u6A21\u5F0F\u4F1A\u66F4\u52A0\u4EBA\u6027\u5316\u3002
</code></pre>
...
<pre><code class="hljs language-!" lang="!">\u6CE8\uFF1A\u4E0B\u6587\u6240\u63D0\u53CA\u7684\u201C\u6709\u6548\u6C47\u62A5\u201D\u6307\u7684\u5C31\u662F\u201C\u7238\u7238\u6211\u8FD9\u91CC\u6709p\u6216\u8005q\u201D\u8FD9\u6837\u5F0F\u513F\u7684\u6C47\u62A5\u54C8
</code></pre>
...
<p>b. \u5F53\u524D\u7ED3\u70B9\u7684\u5DE6\u5B50\u6811/\u53F3\u5B50\u6811\u4E2D\uFF0C<strong>\u540C\u65F6\u5305\u542B\u4E86 <code>p</code> \u548C <code>q</code></strong>\u3002\u5728\u6709\u6548\u6C47\u62A5\u6570\u4E3A1\u7684\u524D\u63D0\u4E0B\uFF0C\u8FD9\u79CD\u5047\u8BBE\u53EA\u53EF\u80FD\u5BF9\u5E94\u4E00\u79CD\u60C5\u51B5\uFF0C<strong>\u90A3\u5C31\u662F<code>p</code>\u548C<code>q</code>\u4E4B\u95F4\u4E92\u4E3A\u7236\u5B50\u5173\u7CFB</strong>\u3002\u6B64\u65F6\u6211\u4EEC\u4ECD\u7136\u662F\u9700\u8981\u5C06<code>p</code>\u548C<code>q</code>\u6240\u5728\u7684\u90A3\u4E2A\u5B50\u6811\u7684\u6839\u7ED3\u70B9\uFF08\u5176\u5B9E\u5C31\u662F<code>p</code>\u6216\u8005<code>q</code>\u4E2D\u4F5C\u4E3A\u7238\u7238\u5B58\u5728\u90A3\u4E2A\uFF09\u4F5C\u4E3A\u6709\u6548\u7ED3\u70B9\u7ED9\u4E0A\u62A5\u4E0A\u53BB\u3002</p>
</li>
</ol>
...
<span class="hljs-keyword">const</span> lowestCommonAncestor = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">root, p, q</span>) </span>{
    ...
    <span class="hljs-comment">// \u8C03\u7528 dfs \u65B9\u6CD5 </span>
    <span class="hljs-keyword">return</span> dfs(root)  
};
</code></pre>
<h2 data-id="heading-3">\u5BFB\u627E\u4E24\u4E2A\u6B63\u5E8F\u6570\u7EC4\u7684\u4E2D\u4F4D\u6570</h2>
<blockquote>
...
<h4 data-id="heading-5">\u7406\u89E3\u4E2D\u4F4D\u6570\u7684\u53D6\u503C\u601D\u8DEF</h4>
<p>\u63A5\u4E0B\u6765\u5C31\u9700\u8981\u601D\u8003\u5207\u5272\u7684\u624B\u6CD5\u4E86\u3002\u5927\u5BB6\u60F3\u60F3\uFF0C\u5982\u679C\u53EA\u5141\u8BB8\u4F60\u7528\u5207\u5272\u7684\u65B9\u5F0F\u6765\u5B9A\u4F4D\u4E24\u4E2A\u6B63\u5E8F\u6570\u7EC4\u7684\u4E2D\u4F4D\u6570\uFF0C\u4F60\u4F1A\u600E\u4E48\u529E\uFF1F\u662F\u4E0D\u662F\u5E94\u8BE5\u9996\u5148\u60F3\u5230\u4ECE<strong>\u5143\u7D20\u7684\u6570\u91CF</strong>\u4E0A\u5165\u624B\uFF1F</p>
<p>\u5177\u4F53\u6765\u8BF4\uFF0C\u5047\u5982\u6211\u8FD9\u91CC\u9700\u8981\u6C42\u89E3\u7684\u662F\u8FD9\u6837\u4E24\u4E2A\u6570\u7EC4\uFF1A</p>
<pre><code class="hljs language-js" lang="js">nums1 = [<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">5</span>, <span class="hljs-number">7</span>, <span class="hljs-number">9</span>]  
...
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">5</span>,| <span class="hljs-number">7</span>, <span class="hljs-number">9</span>]  
|&lt;- s1 -&gt;|  
...
<pre><code class="hljs language-js" lang="js">       L1  R1    
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">// \u53D6 L1 \u548C L2 \u4E2D\u7684\u8F83\u5927\u503C</span>
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-keyword">const</span> median = (R1 &lt; R2) ? R1 : R2  
</code></pre>
...
<h4 data-id="heading-6">\u4E8C\u5206\u601D\u60F3\u786E\u5B9A\u5206\u5272\u70B9</h4>
<p>\u6211\u4EEC\u56DE\u5934\u770B\u8FD9\u4E2A\u6570\u7EC4</p>
<pre><code class="hljs language-js" lang="js">nums1 = [<span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">5</span>, <span class="hljs-number">7</span>, <span class="hljs-number">9</span>]  
nums2 = [<span class="hljs-number">2</span>, <span class="hljs-number">4</span>, <span class="hljs-number">6</span>, <span class="hljs-number">8</span>, <span class="hljs-number">10</span>]
</code></pre>
...
\u6211\u4EEC\u5148\u7528\u7F16\u7801\u8BED\u8A00\u6765\u8868\u8FBE\u4E00\u4E0B\u8FD9\u4E2A\u5173\u7CFB\uFF1A</p>
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">// slice1\u548Cslice2\u5206\u522B\u8868\u793AR1\u7684\u7D22\u5F15\u548CR2\u7684\u7D22\u5F15</span>
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-keyword">const</span> findMedianSortedArrays = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">nums1, nums2</span>) </span>{  
...
<pre><code class="hljs language-js" lang="js">nums1 = [<span class="hljs-number">5</span>, <span class="hljs-number">6</span>, <span class="hljs-number">7</span>] 
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">// \u521D\u59CB\u5316\u7B2C\u4E00\u4E2A\u6570\u7EC4\u4E8C\u5206\u8303\u56F4\u7684\u5DE6\u7AEF\u70B9</span>
...
<pre><code class="hljs language-js" lang="js">slice1 = <span class="hljs-built_in">Math</span>.floor((slice1R - slice1L)/<span class="hljs-number">2</span>) + slice1L  
</code></pre>
<p>\u7136\u540E\u901A\u8FC7\u505A\u51CF\u6CD5\u6C42\u51FA <code>slice2</code>\uFF1A</p>
<pre><code class="hljs language-js" lang="js">slice2 = <span class="hljs-built_in">Math</span>.floor(len/<span class="hljs-number">2</span>) - slice1
</code></pre>
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">// \u5904\u7406L1&gt;R2\u7684\u9519\u8BEF\u60C5\u51B5</span>
 <span class="hljs-keyword">if</span>(L1 &gt; R2) {
    <span class="hljs-comment">// \u5C06slice1R\u5DE6\u79FB\uFF0C\u8FDB\u800C\u4F7Fslice1\u5BF9\u5E94\u7684\u503C\u53D8\u5C0F</span>
    slice1R = slice1 - <span class="hljs-number">1</span>
} <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(L2 &gt; R1) {
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">// len\u8868\u793A\u4E24\u4E2A\u6570\u7EC4\u7684\u603B\u957F\u5EA6</span>
...
<span class="hljs-keyword">const</span> findMedianSortedArrays = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">nums1, nums2</span>) </span>{  
    ...
    <span class="hljs-keyword">while</span>(slice1 &lt;= len1) {
        ...
        <span class="hljs-comment">// \u5904\u7406L1&gt;R2\u7684\u9519\u8BEF\u60C5\u51B5</span>
        <span class="hljs-keyword">if</span>(L1 &gt; R2) {
            <span class="hljs-comment">// \u5C06slice1R\u5DE6\u79FB\uFF0C\u8FDB\u800C\u4F7Fslice1\u5BF9\u5E94\u7684\u503C\u53D8\u5C0F</span>
            slice1R = slice1 - <span class="hljs-number">1</span>
        } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span>(L2 &gt; R1) {
...
<h2 data-id="heading-9">\u201C\u7C89\u5237\u623F\u5B50\u201D\u95EE\u9898</h2>
<blockquote>
...
<pre><code class="hljs language-js" lang="js">f[i][x] = <span class="hljs-built_in">Math</span>.min(f[i-<span class="hljs-number">1</span>][x\u4EE5\u5916\u7684\u7D22\u5F15<span class="hljs-number">1</span>\u53F7], f[i-<span class="hljs-number">1</span>][x\u4EE5\u5916\u7684\u7D22\u5F15<span class="hljs-number">2</span>\u53F7]) + costs[i][x]
</code></pre>
...
<pre><code class="hljs language-js" lang="js">f[<span class="hljs-number">0</span>][<span class="hljs-number">0</span>] = costs[<span class="hljs-number">0</span>][<span class="hljs-number">0</span>]
...
<p><code>f[0][0]</code>\u3001<code>f[0][1]</code>\u3001<code>f[0][2]</code>\u5206\u522B\u8868\u793A\u5F53\u7C89\u5237\u5230\u7B2C0\u4E2A\u623F\u5B50\u65F6\uFF0C\u5BF9\u5B83\u4F7F\u75280\u53F7\u30011\u53F7\u30012\u53F7\u6CB9\u6F06\u5BF9\u5E94\u7684\u603B\u82B1\u8D39\u6210\u672C\u3002\u6B64\u65F6\u7531\u4E8E\u53EA\u7C89\u5237\u4E86\u4E00\u4E2A\u623F\u5B50\uFF0C\u6240\u4EE5\u603B\u82B1\u8D39\u6210\u672C\u5C31\u7B49\u4E8E\u623F\u5B50\u672C\u8EAB\u7684\u82B1\u8D39\u6210\u672C\u3002<br>
\u57FA\u4E8E\u4EE5\u4E0A\u4E24\u4E2A\u7ED3\u8BBA\uFF0C\u6211\u4EEC\u53EF\u4EE5\u6709\u5982\u4E0B\u7684\u521D\u6B65\u7F16\u7801\uFF1A</p>
<h3 data-id="heading-11">\u7F16\u7801\u5B9E\u73B0-\u57FA\u7840\u7248</h3>
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">/**
...
<h3 data-id="heading-12">\u7F16\u7801\u5B9E\u73B0-\u4F18\u5316\u7248</h3>
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">/**
 * <span class="hljs-doctag">@param <span class="hljs-type">{number[][]}</span> <span class="hljs-variable">costs</span></span>
 * <span class="hljs-doctag">@return <span class="hljs-type">{number}</span></span>
 */</span>
