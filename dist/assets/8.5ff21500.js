...
<h2 data-id="heading-1">\u88C5\u9970\u5668\u7684\u5E94\u7528\u573A\u666F</h2>
...
<pre><code class="hljs language-!" lang="!">\u6211\u60F3\u4E00\u5B9A\u4F1A\u6709\u540C\u5B66\u8D28\u7591\u8BF4\u4E3A\u5565\u4E0D\u628A\u6309\u94AE\u62BD\u6210\u516C\u5171\u7EC4\u4EF6 Button\uFF0C\u8FD9\u6837\u53EA\u9700\u8981\u5728 Button \u7EC4\u4EF6\u91CC\u4FEE\u6539\u4E00\u6B21\u903B\u8F91\u5C31\u53EF\u4EE5\u4E86\u3002\u8FD9\u79CD\u60F3\u6CD5\u975E\u5E38\u597D\u3002\u4F46\u6CE8\u610F\uFF0C\u6211\u4EEC\u697C\u4E0A\u7684\u4F8B\u5B50\u6CA1\u6709\u5199\u7EC4\u4EF6\u76F4\u63A5\u5199\u4E86 Button \u6807\u7B7E\u662F\u4E3A\u4E86\u7B80\u5316\u793A\u4F8B\u3002\u4E8B\u5B9E\u4E0A\u771F\u8981\u5199\u7EC4\u4EF6\u7684\u8BDD\uFF0C\u4E0D\u540C\u4E1A\u52A1\u91CC\u5FC5\u5B9A\u6709\u9488\u5BF9\u4E1A\u52A1\u5B9A\u5236\u7684\u4E0D\u540C Button \u7EC4\u4EF6\uFF0C\u6BD4\u5982 MoreButton \u3001BeginButton\u7B49\u7B49\uFF0C\u4E5F\u662F\u4E94\u82B1\u516B\u95E8\u7684\uFF0C\u6240\u4EE5\u8BF4\u6211\u4EEC\u4ECD\u4F1A\u9047\u5230\u540C\u6837\u7684\u56F0\u5883\u3002        
</code></pre>
...
<h2 data-id="heading-2">\u88C5\u9970\u5668\u6A21\u5F0F\u521D\u76F8\u89C1</h2>
<p>\u4E3A\u4E86\u4E0D\u88AB\u5DF2\u6709\u7684\u4E1A\u52A1\u903B\u8F91\u5E72\u6270\uFF0C\u5F53\u52A1\u4E4B\u6025\u5C31\u662F\u5C06\u65E7\u903B\u8F91\u4E0E\u65B0\u903B\u8F91\u5206\u79BB\uFF0C<strong>\u628A\u65E7\u903B\u8F91\u62BD\u51FA\u53BB</strong>\uFF1A</p>
<pre><code class="hljs language-javascript" lang="javascript"><span class="hljs-comment">// \u5C06\u5C55\u793AModal\u7684\u903B\u8F91\u5355\u72EC\u5C01\u88C5</span>
...
<p>\u7F16\u5199\u65B0\u903B\u8F91\uFF1A</p>
<pre><code class="hljs language-javascript" lang="javascript"><span class="hljs-comment">// \u6309\u94AE\u6587\u6848\u4FEE\u6539\u903B\u8F91</span>
...
<pre><code class="hljs language-javascript" lang="javascript"><span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'open'</span>).addEventListener(<span class="hljs-string">'click'</span>, <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    openModal()
    changeButtonStatus()
})
</code></pre>
<p>\u5982\u6B64\u4E00\u6765\uFF0C\u6211\u4EEC\u5C31\u5B9E\u73B0\u4E86\u201C\u53EA\u6DFB\u52A0\uFF0C\u4E0D\u4FEE\u6539\u201D\u7684\u88C5\u9970\u5668\u6A21\u5F0F\uFF0C\u4F7F\u7528changeButtonStatus\u7684\u903B\u8F91\u88C5\u9970\u4E86\u65E7\u7684\u6309\u94AE\u70B9\u51FB\u903B\u8F91\u3002\u4EE5\u4E0A\u662FES5\u4E2D\u7684\u5B9E\u73B0\uFF0CES6\u4E2D\uFF0C\u6211\u4EEC\u53EF\u4EE5\u4EE5\u4E00\u79CD\u66F4\u52A0\u9762\u5411\u5BF9\u8C61\u5316\u7684\u65B9\u5F0F\u53BB\u5199\uFF1A</p>
<pre><code class="hljs language-javascript" lang="javascript"><span class="hljs-comment">// \u5B9A\u4E49\u6253\u5F00\u6309\u94AE</span>
...
<span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Decorator</span> </span>{
    ...
    <span class="hljs-function"><span class="hljs-title">constructor</span>(<span class="hljs-params">open_button</span>)</span> {
        <span class="hljs-built_in">this</span>.open_button = open_button
    }
    
    <span class="hljs-function"><span class="hljs-title">onClick</span>(<span class="hljs-params"></span>)</span> {
        <span class="hljs-built_in">this</span>.open_button.onClick()
        <span class="hljs-comment">// \u201C\u5305\u88C5\u201D\u4E86\u4E00\u5C42\u65B0\u903B\u8F91</span>
        <span class="hljs-built_in">this</span>.changeButtonStatus()
    }
    
    <span class="hljs-function"><span class="hljs-title">changeButtonStatus</span>(<span class="hljs-params"></span>)</span> {
        <span class="hljs-built_in">this</span>.changeButtonText()
        <span class="hljs-built_in">this</span>.disableButton()
    }
    
    <span class="hljs-function"><span class="hljs-title">disableButton</span>(<span class="hljs-params"></span>)</span> {
        <span class="hljs-keyword">const</span> btn =  <span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'open'</span>)
        btn.setAttribute(<span class="hljs-string">"disabled"</span>, <span class="hljs-literal">true</span>)
    }
    
    <span class="hljs-function"><span class="hljs-title">changeButtonText</span>(<span class="hljs-params"></span>)</span> {
        <span class="hljs-keyword">const</span> btn = <span class="hljs-built_in">document</span>.getElementById(<span class="hljs-string">'open'</span>)
        btn.innerText = <span class="hljs-string">'\u5FEB\u53BB\u767B\u5F55'</span>
    }
}
