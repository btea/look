...
<h2 data-id="heading-0">\u65F6\u95F4\u590D\u6742\u5EA6</h2>
<p>\u5927\u5BB6\u5148\u6765\u770B\u8FD9\u6837\u4E00\u4E2A\u95EE\u9898\uFF1A\u4E0B\u9762\u8FD9\u6BB5\u4EE3\u7801\uFF0C\u4E00\u5171\u4F1A\u6267\u884C\u591A\u5C11\u6B21\uFF1F</p>
<pre><code class="hljs language-js" lang="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">traverse</span>(<span class="hljs-params">arr</span>) </span>{
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-keyword">var</span> len = arr.length
</code></pre>
<p>\u5176\u6B21\u6CA1\u6709\u60AC\u5FF5\u7684\u662F\u5FAA\u73AF\u4F53\uFF1A</p>
<pre><code class="hljs language-js" lang="js"><span class="hljs-built_in">console</span>.log(arr[i])
</code></pre>
...
<pre><code class="">T(n) = 1 + n + 1 + (n+1) + n = 3n + 3
</code></pre>
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-keyword">var</span> outLen = arr.length
</code></pre>
<p>\u63A5\u4E0B\u6765\u6211\u4EEC\u6765\u770B\u6700\u5185\u5C42\u7684\u5FAA\u73AF\u4F53\uFF1A</p>
<pre><code class="hljs language-js" lang="js"><span class="hljs-built_in">console</span>.log(arr[i][j])
</code></pre>
<p>\u56E0\u4E3A\u54B1\u4EEC\u662F\u4E24\u5C42\u5FAA\u73AF\uFF0C\u6240\u4EE5\u8FD9\u8D27\u4F1A\u88AB\u6267\u884C <code>n*n = n^2</code> \u6B21\u3002<br>
\u5176\u5B83\u8BED\u53E5\u7684\u8BA1\u7B97\u601D\u8DEF\u548C\u54B1\u4EEC\u7B2C\u4E00\u4E2A\u{1F330}\u533A\u522B\u4E0D\u5927\uFF0C\u8FD9\u91CC\u6211\u5C31\u4E0D\u91CD\u590D\u8BB2\u4E86\uFF0C\u76F4\u63A5\u7ED9\u51FA\u5927\u5BB6\u7B54\u6848\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/6/1714f38044f931dd~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<p>\u7EE7\u7EED\u6765\u505A\u4E2A\u6C42\u603B\u6267\u884C\u6B21\u6570 T(n) \u7684\u52A0\u6CD5\u770B\u770B\uFF1A</p>
<pre><code class="hljs language-js" lang="js">T(n) = <span class="hljs-number">1</span> + <span class="hljs-number">1</span> + (n+<span class="hljs-number">1</span>) + n + n + n + n*(n+<span class="hljs-number">1</span>) + n*n + n*n = <span class="hljs-number">3n</span>^<span class="hljs-number">2</span> + <span class="hljs-number">5n</span> + <span class="hljs-number">3</span>
</code></pre>
...
<pre><code class="">T(n) = 10  
O(n) = 1
</code></pre>
<pre><code class="">T(n) = 3n^2 + 5n + 3
O(n) = n^2
</code></pre>
<p>\u5230\u8FD9\u91CC\uFF0C\u6211\u4EEC\u601D\u8DEF\u4ECD\u7136\u662F <code>\u8BA1\u7B97T(n) -&gt; \u63A8\u5BFCO(n)</code>\u3002\u8FD9\u4E48\u8BB2\u662F\u4E3A\u4E86\u65B9\u4FBF\u5927\u5BB6\u7406\u89E3 O(n) \u7684\u7B80\u5316\u8FC7\u7A0B\uFF0C\u5B9E\u9645\u64CD\u4F5C\u4E2D\uFF0CO(n) \u57FA\u672C\u53EF\u4EE5\u76EE\u6D4B\uFF0C\u6BD4\u5982\u54B1\u4EEC\u4E0A\u9762\u7684\u4E24\u4E2A\u904D\u5386\u51FD\u6570\uFF1A</p>
<pre><code class="hljs language-js" lang="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">traverse1</span>(<span class="hljs-params">arr</span>) </span>{
    <span class="hljs-keyword">var</span> len = arr.length
    <span class="hljs-keyword">for</span>(<span class="hljs-keyword">var</span> i=<span class="hljs-number">0</span>;i&lt;len;i++) {
        <span class="hljs-built_in">console</span>.log(arr[i])
    }
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">fn</span>(<span class="hljs-params">arr</span>) </span>{
    <span class="hljs-keyword">var</span> len = arr.length  
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/6/1714f5c2b41495c3~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<p>\u4E5F\u5C31\u662F\u8BF4\uFF0C\u53EA\u6709\u5F53 <code>x</code> \u5C0F\u4E8E <code>log2n</code> \u7684\u65F6\u5019\uFF0C\u5FAA\u73AF\u624D\u662F\u6210\u7ACB\u7684\u3001\u5FAA\u73AF\u4F53\u624D\u80FD\u6267\u884C\u3002\u6CE8\u610F\u6D89\u53CA\u5230\u5BF9\u6570\u7684\u65F6\u95F4\u590D\u6742\u5EA6\uFF0C\u5E95\u6570\u548C\u7CFB\u6570\u90FD\u662F\u8981\u88AB\u7B80\u5316\u6389\u7684\u3002\u90A3\u4E48\u8FD9\u91CC\u7684 O(n) \u5C31\u53EF\u4EE5\u8868\u793A\u4E3A\uFF1A</p>
<pre><code class="hljs language-js" lang="js">O(n) = logn
</code></pre>
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/6/1714f67c52dc8d15~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<h2 data-id="heading-1">\u7A7A\u95F4\u590D\u6742\u5EA6</h2>
...
<p>\u4E0B\u9762\u6211\u4EEC\u6765\u770B\u53E6\u4E00\u4E2A\u{1F330}\uFF0C\u6B64\u65F6\u6211\u60F3\u8981\u521D\u59CB\u5316\u4E00\u4E2A\u89C4\u6A21\u4E3A n \u7684\u6570\u7EC4\uFF0C\u5E76\u4E14\u8981\u6C42\u8FD9\u4E2A\u6570\u7EC4\u7684\u6BCF\u4E2A\u5143\u7D20\u7684\u503C\u4E0E\u5176\u7D22\u5F15\u59CB\u7EC8\u662F\u76F8\u7B49\u5173\u7CFB\uFF0C\u6211\u53EF\u4EE5\u8FD9\u6837\u5199\uFF1A</p>
<pre><code class="hljs language-js" lang="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">init</span>(<span class="hljs-params">n</span>) </span>{
