...
<h2 data-id="heading-0">\u4E3A\u4EC0\u4E48\u4E00\u9053\u9898\u53EF\u4EE5\u6210\u4E3A\u9AD8\u9891\u9762\u8BD5\u9898</h2>
...
<h2 data-id="heading-1">\u5982\u4F55\u7528\u6808\u5B9E\u73B0\u4E00\u4E2A\u961F\u5217\uFF1F</h2>
<blockquote>
<p>\u9898\u76EE\u63CF\u8FF0\uFF1A\u4F7F\u7528\u6808\u5B9E\u73B0\u961F\u5217\u7684\u4E0B\u5217\u64CD\u4F5C\uFF1A</p>
</blockquote>
...
<p>MyQueue queue = new MyQueue();<br>
queue.push(1);<br>
queue.push(2);<br>
queue.peek();  // \u8FD4\u56DE 1<br>
queue.pop();   // \u8FD4\u56DE 1<br>
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/13/171735fc8ee608ea~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<ul>
<li>
<p>\u73B0\u5728\u95EE\u9898\u662F\uFF0C\u600E\u4E48\u628A\u7B2C\u4E00\u4E2A\u6808\u5E95\u4E0B\u7684\u90A3\u4E2A 1 \u7ED9\u64AC\u51FA\u6765\u3002\u4ED4\u7EC6\u60F3\u60F3\uFF0C\u963B\u788D\u6211\u4EEC\u63A5\u89E6\u5230 1 \u7684\u662F\u5565\uFF1F\u662F\u4E0D\u662F\u5B83\u5934\u4E0A\u7684 3 \u548C 2\uFF1F\u90A3\u4E48\u5982\u4F55\u8BA9 3 \u548C 2 \u7ED9 1 \u8BA9\u8DEF\u5462\uFF1F\u5B9E\u9645\u4E0A\u54B1\u4EEC\u5B8C\u5168\u53EF\u4EE5\u628A\u8FD9\u4E09\u4E2A\u5143\u7D20\u6309\u987A\u5E8F\u4ECE stack1 \u4E2D\u51FA\u6808\u3001\u7136\u540E\u5165\u6808\u5230 stack 2 \u91CC\u53BB\uFF1A</p>
</li>
</ul>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/13/17173813ab3377b1~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<ul>
<li>\u6B64\u65F6 1 \u53D8\u5F97\u89E6\u624B\u53EF\u53CA\u3002\u4E0D\u4EC5\u5982\u6B64\uFF0C\u4E0B\u4E00\u6B21\u6211\u4EEC\u8BD5\u56FE\u51FA\u961F 2 \u7684\u65F6\u5019\uFF0C\u53EF\u4EE5\u7EE7\u7EED\u76F4\u63A5\u5BF9 stack2 \u6267\u884C\u51FA\u6808\u64CD\u4F5C\u2014\u2014\u56E0\u4E3A\u8F6C\u79FB 2 \u548C 3 \u7684\u65F6\u5019\u5DF2\u7ECF\u505A\u8FC7\u4E00\u6B21\u9006\u5E8F\u4E86\uFF0C\u6B64\u65F6 stack2 \u7684\u51FA\u6808\u5E8F\u5217\u521A\u597D\u5C31\u5BF9\u5E94\u961F\u5217\u7684\u51FA\u961F\u5E8F\u5217\u3002</li>
<li>\u6709\u540C\u5B66\u4F1A\u95EE\uFF0C\u90A3\u5982\u679C stack1 \u91CC\u5165\u6808\u65B0\u5143\u7D20\u600E\u4E48\u529E\uFF1F\u6BD4\u5982\u8FD9\u6837\uFF1A</li>
</ul>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/13/171738289370743a~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
 ...
 * \u521D\u59CB\u5316\u6784\u9020\u51FD\u6570
 */</span>
<span class="hljs-keyword">const</span> MyQueue = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
...
MyQueue.prototype.pop = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params"></span>) </span>{
  ...
  <span class="hljs-keyword">if</span> (<span class="hljs-built_in">this</span>.stack2.length &lt;= <span class="hljs-number">0</span>) {
    <span class="hljs-comment">// \u5F53 stack1 \u4E0D\u4E3A\u7A7A\u65F6\uFF0C\u51FA\u6808</span>
    <span class="hljs-keyword">while</span> (<span class="hljs-built_in">this</span>.stack1.length !== <span class="hljs-number">0</span>) {
      <span class="hljs-comment">// \u5C06 stack1 \u51FA\u6808\u7684\u5143\u7D20\u63A8\u5165 stack2</span>
      <span class="hljs-built_in">this</span>.stack2.push(<span class="hljs-built_in">this</span>.stack1.pop());
    }
  }
  <span class="hljs-comment">// \u4E3A\u4E86\u8FBE\u5230\u9006\u5E8F\u7684\u76EE\u7684\uFF0C\u6211\u4EEC\u53EA\u4ECE stack2 \u91CC\u51FA\u6808\u5143\u7D20</span>
  <span class="hljs-keyword">return</span> <span class="hljs-built_in">this</span>.stack2.pop();
};
...
<h2 data-id="heading-4">\u8BA4\u8BC6\u53CC\u7AEF\u961F\u5217</h2>
...
<h2 data-id="heading-5">\u6ED1\u52A8\u7A97\u53E3\u95EE\u9898</h2>
<blockquote>
...
<h3 data-id="heading-6">\u601D\u8DEF\u5206\u6790\uFF1A\u53CC\u6307\u9488+\u904D\u5386\u6CD5</h3>
<p>\u8FD9\u9053\u9898\u5982\u679C\u53EA\u662F\u4E3A\u4E86\u505A\u5BF9\uFF0C\u90A3\u4E48\u601D\u8DEF\u5176\u5B9E\u4E0D\u96BE\u60F3\uFF0C\u6211\u4EEC\u76F4\u63A5\u6A21\u62DF\u9898\u4E2D\u63CF\u8FF0\u7684\u8FD9\u4E2A\u8FC7\u7A0B\u5C31\u884C\u3002<br>
\u6309\u7167\u9898\u610F\uFF0C\u5B83\u8981\u6C42\u6211\u4EEC\u5728\u904D\u5386\u6570\u7EC4\u7684\u8FC7\u7A0B\u5F53\u4E2D\uFF0C\u7EA6\u675F\u4E00\u4E2A\u7A97\u53E3\u2014\u2014\u7A97\u53E3\u7684\u672C\u8D28\u5176\u5B9E\u5C31\u662F\u4E00\u4E2A\u8303\u56F4\uFF0C\u50CF\u8FD9\u6837\uFF1A</p>
<pre><code class="">[1  3  -1] -3  5  3  6  7 
</code></pre>
<p>\u8303\u56F4\u5C31\u88AB\u5708\u5B9A\u5728\u4E86\u524D\u4E09\u4E2A\u5143\u7D20\u3002<br>
\u6211\u4EEC\u524D\u9762\u5B66\u8FC7\uFF0C\u7EA6\u675F\u8303\u56F4\uFF0C\u53EF\u4EE5\u7528\u53CC\u6307\u9488\u3002\u56E0\u6B64\u6211\u8FD9\u91CC\u5B9A\u4E49\u4E00\u4E2A <code>left</code> \u5DE6\u6307\u9488\u3001\u5B9A\u4E49\u4E00\u4E2A <code>right</code> \u53F3\u6307\u9488\uFF0C\u5206\u522B\u6307\u5411\u7A97\u53E3\u7684\u4E24\u7AEF\u5373\u53EF\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171915c3ae13a951~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
\u63A5\u4E0B\u6765\u6211\u4EEC\u53EF\u4EE5\u628A\u8FD9\u4E2A\u7A97\u53E3\u91CC\u7684\u6570\u5B57\u53D6\u51FA\u6765\uFF0C\u76F4\u63A5\u904D\u5386\u4E00\u904D\u3001\u6C42\u51FA\u6700\u5927\u503C\uFF0C\u7136\u540E\u628A\u6700\u5927\u503C\u5B58\u8FDB\u7ED3\u679C\u6570\u7EC4\u3002\u8FD9\u6837\u7B2C\u4E00\u4E2A\u7A97\u53E3\u7684\u6700\u5927\u503C\u5C31\u6709\u4E86\u3002</p>
<p>\u63A5\u7740\u6309\u7167\u9898\u610F\uFF0C\u7A97\u53E3\u6BCF\u6B21\u524D\u8FDB\u4E00\u6B65\uFF08\u5DE6\u53F3\u6307\u9488\u6BCF\u6B21\u4E00\u8D77\u5F80\u524D\u8D70\u4E00\u6B65\uFF09\uFF0C\u6B64\u65F6\u7684\u8303\u56F4\u53D8\u6210\u4E86\u8FD9\u6837\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171915c9c9f694db~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
\u6211\u4EEC\u8981\u505A\u7684\u4ECD\u7136\u662F\u53D6\u51FA\u5F53\u524D\u8303\u56F4\u7684\u6240\u6709\u5143\u7D20\u3001\u904D\u5386\u4E00\u904D\u6C42\u51FA\u6700\u5927\u503C\uFF0C\u7136\u540E\u5C06\u6700\u5927\u503C\u5B58\u8FDB\u7ED3\u679C\u6570\u7EC4\u3002</p>
<p>\u53CD\u590D\u6267\u884C\u4E0A\u9762\u8FD9\u4E2A\u8FC7\u7A0B\uFF0C\u76F4\u5230\u6570\u7EC4\u5B8C\u5168\u88AB\u6ED1\u52A8\u7A97\u53E3\u904D\u5386\u5B8C\u6BD5\uFF0C\u6211\u4EEC\u4E5F\u5C31\u5F97\u5230\u4E86\u95EE\u9898\u7684\u7B54\u6848\u3002</p>
<p>\u57FA\u4E8E\u8FD9\u4E2A\u6DF3\u6734\u7684\u601D\u8DEF\uFF0C\u6211\u4EEC\u6765\u5199\u4E00\u6CE2\u4EE3\u7801\uFF1A</p>
<h3 data-id="heading-7">\u7F16\u7801\u5B9E\u73B0\uFF1A\u53CC\u6307\u9488+\u904D\u5386\u6CD5</h3>
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">/**
...
<h3 data-id="heading-9">\u601D\u8DEF\u5206\u6790\uFF1A\u53CC\u7AEF\u961F\u5217\u6CD5</h3>
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171916004417d924~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171916b7462c1b87~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
...
<p>\u6211\u7528\u52A8\u753B\u6765\u8868\u8FBE\u4E00\u4E0B\u8FD9\u4E2A\u8FC7\u7A0B\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171918a1ae330dd3~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<p>\uFF08\u6CE8\uFF1A\u52A8\u753B\u5927\u5C0F\u5DF2\u7ECF\u6781\u81F4\u538B\u7F29\uFF0C\u5982\u679C\u4ECD\u7136\u5B58\u5728\u52A0\u8F7D\u5931\u8D25\u95EE\u9898\uFF0C\u53EF\u80FD\u4E0E\u7F51\u7EDC\u73AF\u5883\u6709\u5173\u3002\u5982\u679C\u4F60\u9047\u5230\u4E86\u8FD9\u4E2A\u95EE\u9898\uFF0C\u5EFA\u8BAE PC \u7AEF\u70B9\u51FB<a href="https://link.juejin.cn?target=https%3A%2F%2Fp1-jj.byteimg.com%2Ftos-cn-i-t2oaga2asx%2Fgold-user-assets%2F2020%2F4%2F19%2F171918a1ae330dd3~tplv-t2oaga2asx-image.image" target="_blank" rel="nofollow noopener noreferrer" title="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171918a1ae330dd3~tplv-t2oaga2asx-image.image" ref="nofollow noopener noreferrer">\u8FD9\u91CC</a>\u76F4\u63A5\u8BBF\u95EE\u52A8\u56FE\u8BD5\u8BD5\u770B\uFF09</p>
<p>\u7EF4\u6301\u9012\u51CF\u961F\u5217\u7684\u76EE\u7684\uFF0C\u5C31\u5728\u4E8E<strong>\u786E\u4FDD\u961F\u5934\u5143\u7D20\u59CB\u7EC8\u662F\u5F53\u524D\u7A97\u53E3\u7684\u6700\u5927\u503C</strong>\u3002<br>
\u5F53\u904D\u5386\u5230\u7684\u5143\u7D20\u4E2A\u6570\u8FBE\u5230\u4E86 <code>k</code> \u4E2A\u65F6\uFF0C\u610F\u5473\u7740\u6ED1\u52A8\u7A97\u53E3\u7684\u7B2C\u4E00\u4E2A\u6700\u5927\u503C\u5DF2\u7ECF\u4EA7\u751F\u4E86\uFF0C\u6211\u4EEC\u628A\u5B83 push \u8FDB\u7ED3\u679C\u6570\u7EC4\u91CC\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171916d956b7871b~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<p>\u7136\u540E\u7EE7\u7EED\u524D\u8FDB\uFF0C\u6211\u4EEC\u53D1\u73B0\u6570\u7EC4\u7D22\u5F15 0 \u5904\u7684\u5143\u7D20\uFF08<code>1</code>\uFF09\u5DF2\u7ECF\u88AB\u8E22\u51FA\u6ED1\u52A8\u7A97\u53E3\u4E86\uFF08\u56FE\u4E2D\u7EA2\u8272\u65B9\u5757\u5BF9\u5E94\u7684\u662F\u5F53\u524D\u6ED1\u52A8\u7A97\u53E3\u8986\u76D6\u5230\u7684\u5143\u7D20\u4EEC\uFF09\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/171916fec2ae69a2~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/19/17191713bc7336d2~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
