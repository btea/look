...
<h2 data-id="heading-3">\u6808\u95EE\u9898\u8FDB\u9636-\u6BCF\u65E5\u6E29\u5EA6\u95EE\u9898</h2>
<blockquote>
...
\u5F53\u904D\u5386\u8FC7\u7684\u6E29\u5EA6\uFF0C\u7EF4\u6301\u7684\u662F\u4E00\u4E2A<strong>\u5355\u8C03\u9012\u51CF</strong>\u7684\u6001\u52BF\u65F6\uFF0C\u6211\u4EEC\u5C31\u5BF9\u8FD9\u4E9B\u6E29\u5EA6\u7684\u7D22\u5F15\u4E0B\u6807\u6267\u884C\u5165\u6808\u64CD\u4F5C\uFF1B\u53EA\u8981\u51FA\u73B0\u4E86\u4E00\u4E2A\u6570\u5B57\uFF0C\u5B83\u6253\u7834\u4E86\u8FD9\u79CD\u5355\u8C03\u9012\u51CF\u7684\u8D8B\u52BF\uFF0C\u4E5F\u5C31\u662F\u8BF4\u5B83\u6BD4\u524D\u4E00\u4E2A\u6E29\u5EA6\u503C\u9AD8\uFF0C\u8FD9\u65F6\u6211\u4EEC\u5C31\u5BF9\u524D\u540E\u4E24\u4E2A\u6E29\u5EA6\u7684\u7D22\u5F15\u4E0B\u6807\u6C42\u5DEE\uFF0C\u5F97\u51FA\u524D\u4E00\u4E2A\u6E29\u5EA6\u8DDD\u79BB\u7B2C\u4E00\u6B21\u5347\u6E29\u7684\u76EE\u6807\u5DEE\u503C\u3002\u8FD9\u4E48\u8BF4\u53EF\u80FD\u6709\u70B9\u62BD\u8C61\uFF0C\u6211\u4EEC\u7528\u4E00\u5F20\u52A8\u56FE\u6765\u7406\u89E3\u4E00\u4E0B\u8FD9\u4E2A\u8FC7\u7A0B\uFF08\u8FD9\u4E2A\u8FC7\u7A0B\u5B9E\u9645\u6709\u5C06\u8FD1\u4E00\u5206\u949F\u90A3\u4E48\u957F\uFF0C\u8D34\u4E0A\u6765\u4E4B\u540E\u6211\u53D1\u73B0\u5B8C\u5168\u52A0\u8F7D\u4E0D\u51FA\u6765\uFF0C\u8FD9\u91CC\u5448\u73B0\u7684\u662F\u622A\u6B62\u5230\u7B2C\u4E00\u4E2A\u5143\u7D20\u51FA\u6808\u7684\u7247\u6BB5\uFF0C\u5B8C\u6574\u7684\u89C6\u9891\u6211\u8FD9\u8FB9\u4E0A\u4F20\u5230\u4E86<a href="https://link.juejin.cn?target=https%3A%2F%2Fwww.bilibili.com%2Fvideo%2FBV12t4y1274o%2F" target="_blank" rel="nofollow noopener noreferrer" title="https://www.bilibili.com/video/BV12t4y1274o/" ref="nofollow noopener noreferrer">\u5C0F\u7834\u7AD9</a>\uFF09\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/4/14/17177748909c5571~tplv-t2oaga2asx-watermark.awebp" alt="\u6E29\u5EA6\u95EE\u9898\u7684\u52A8\u753B" loading="lazy" class="medium-zoom-image"></p>
...
<h2 data-id="heading-6">\u6808\u7684\u8BBE\u8BA1\u2014\u2014\u201C\u6700\u5C0F\u6808\u201D\u95EE\u9898</h2>
<blockquote>
...
<h3 data-id="heading-8">\u7F16\u7801\u5B9E\u73B01</h3>
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">/**
 * \u521D\u59CB\u5316\u4F60\u7684\u6808\u7ED3\u6784
 */</span>
<span class="hljs-keyword">const</span> MinStack = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
...
MinStack.prototype.top = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
  <span class="hljs-keyword">if</span>(!<span class="hljs-built_in">this</span>.stack || !<span class="hljs-built_in">this</span>.stack.length) {
...
MinStack.prototype.getMin = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    ...
    <span class="hljs-keyword">const</span>  { stack } = <span class="hljs-built_in">this</span>
...
<h3 data-id="heading-9">\u7F16\u7801\u5B9E\u73B02</h3>
<pre><code class="hljs language-js" lang="js"><span class="hljs-keyword">const</span> MinStack = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params"></span>) </span>{
    <span class="hljs-built_in">this</span>.stack = [];
