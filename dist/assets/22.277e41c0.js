...
<pre><code class="hljs language-!" lang="!">\u4ECE\u524D\u9762\u4E00\u7CFB\u5217\u7AE0\u8282\u7684\u5B66\u4E60\u53CD\u9988\u4E2D\uFF0C\u7B14\u8005\u89C2\u5BDF\u5230\u4E00\u90E8\u5206\u540C\u5B66\u7684\u9605\u8BFB\u4E60\u60EF\u975E\u5E38\u201C\u8584\u60C5\u201D\u2014\u2014\u6253\u5F00\u5C0F\u518C\u53EA\u4E3A\u505A\u9898\uFF0C\u505A\u5B8C\u5C31\u6E9C\uFF0C\u8BB2\u89E3\u90E8\u5206\u57FA\u672C\u662F\u4E0D\u770B\u7684\u3002 

\u8FD9\u91CC\u60F3\u8981\u63D0\u9192\u5927\u5BB6\u7684\u662F\uFF0C\u9898\u76EE\u672C\u8EAB\u4E0D\u4EC5\u4EC5\u662F\u547D\u9898\u70B9\uFF0C\u66F4\u662F\u7D20\u6750\u3001\u662F\u6559\u5177\uFF0C\u5927\u5BB6\u6700\u7EC8\u8981\u5173\u6CE8\u5230\u7684\u8FD8\u662F\u9898\u76EE\u80CC\u540E\u7684\u601D\u60F3\u548C\u65B9\u6CD5\u3002\u56E0\u6B64\u5E0C\u671B\u540C\u5B66\u4EEC\u80FD\u591A\u7ED9\u81EA\u5DF1\u4E00\u70B9\u65F6\u95F4\u3001\u591A\u4E00\u4E9B\u8010\u5FC3\u53BB\u53CD\u520D\u548C\u5438\u6536\u77E5\u8BC6\u3002
</code></pre>
<h2 data-id="heading-1">\u4ECE\u201C\u722C\u697C\u68AF\u201D\u95EE\u9898\u8BF4\u8D77</h2>
<blockquote>
...
<h3 data-id="heading-2">\u601D\u8DEF\u5206\u6790\u4E0E\u7F16\u7801\u5B9E\u73B0</h3>
<p>\u8FD9\u9053\u9898\u76EE\u6709\u4E24\u4E2A\u5173\u952E\u7684\u7279\u5F81\uFF1A</p>
<ol>
...
<h4 data-id="heading-3">Step1\uFF1A\u9012\u5F52\u601D\u60F3\u5206\u6790\u95EE\u9898</h4>
...
<pre><code class="hljs language-js" lang="js">f(n) = f(n-<span class="hljs-number">1</span>) + f(n-<span class="hljs-number">2</span>)
</code></pre>
<p>\u8FD9\u4E2A\u5173\u7CFB\u7528\u6811\u5F62\u7ED3\u6784\u8868\u793A\u4F1A\u66F4\u52A0\u5F62\u8C61</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/6/14/172b19208c250e8a~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
...
<pre><code class="hljs language-js" lang="js">f(n-<span class="hljs-number">1</span>) = f(n-<span class="hljs-number">2</span>) + f(n-<span class="hljs-number">3</span>)
</code></pre>
<p>\u540C\u7406\uFF0C <code>f(n-2)</code>\u4E5F\u53EF\u4EE5\u6309\u7167\u540C\u6837\u7684\u89C4\u5219\u8FDB\u884C\u62C6\u5206\uFF1A</p>
<pre><code class="hljs language-js" lang="js">f(n-<span class="hljs-number">2</span>) = f(n-<span class="hljs-number">3</span>) + f(n-<span class="hljs-number">4</span>)
</code></pre>
<p>\u73B0\u5728\u6211\u4EEC\u7684\u6811\u7ED3\u6784\u6E10\u6E10\u4E30\u6EE1\u8D77\u6765\u4E86\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/6/14/172b19913098a464~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
...
<pre><code class="hljs language-js" lang="js">f(<span class="hljs-number">1</span>) = <span class="hljs-number">1</span>   
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/6/14/172b199e151d2d3d~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
...
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/7/28/1739430a97f10d22~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image">
\uFF08\u56FE\u4E0A\u6807\u7EA2\u7684\u5747\u4E3A\u53D1\u751F\u8FC7\u91CD\u590D\u8BA1\u7B97\u7684\u7ED3\u70B9\uFF09</p>
<h4 data-id="heading-4">Step2\uFF1A\u8BB0\u5FC6\u5316\u641C\u7D22\u6765\u63D0\u6548</h4>
<p>\u91CD\u590D\u8BA1\u7B97\u5E26\u6765\u4E86\u65F6\u95F4\u6548\u7387\u4E0A\u7684\u95EE\u9898\uFF0C\u8981\u60F3\u89E3\u51B3\u8FD9\u7C7B\u95EE\u9898\uFF0C\u6700\u76F4\u63A5\u7684\u601D\u8DEF\u5C31\u662F\u7528\u7A7A\u95F4\u6362\u65F6\u95F4\uFF0C\u4E5F\u5C31\u662F\u60F3\u529E\u6CD5\u8BB0\u4F4F\u4E4B\u524D\u5DF2\u7ECF\u6C42\u89E3\u8FC7\u7684\u7ED3\u679C\u3002\u8FD9\u91CC\u6211\u4EEC\u53EA\u9700\u8981\u5B9A\u4E49\u4E00\u4E2A\u6570\u7EC4\uFF1A</p>
<pre><code class="hljs language-js" lang="js"><span class="hljs-keyword">const</span> f = []
</code></pre>
...
\u884C\u5427\uFF0C\u5C31\u7ED9\u4F60\u52A8\u6001\u89C4\u5212\u7684\u89E3\u6CD5\u3002</p>
<h4 data-id="heading-5">Step3\uFF1A\u8BB0\u5FC6\u5316\u641C\u7D22\u8F6C\u5316\u4E3A\u52A8\u6001\u89C4\u5212</h4>
<p>\u8981\u60F3\u5B8C\u6210\u8BB0\u5FC6\u5316\u641C\u7D22\u4E0E\u52A8\u6001\u89C4\u5212\u4E4B\u95F4\u7684\u8F6C\u5316\uFF0C\u9996\u5148\u8981\u6E05\u695A\u4E24\u8005\u95F4\u7684\u533A\u522B\u3002<br>
\u5148\u8BF4\u8BB0\u5FC6\u5316\u641C\u7D22\uFF0C\u8BB0\u5FC6\u5316\u641C\u7D22\u53EF\u4EE5\u7406\u89E3\u4E3A\u4F18\u5316\u8FC7\u540E\u7684\u9012\u5F52\u3002\u9012\u5F52\u5F80\u5F80\u53EF\u4EE5\u57FA\u4E8E\u6811\u5F62\u601D\u7EF4\u6A21\u578B\u6765\u505A\uFF0C\u4EE5\u8FD9\u9053\u9898\u4E3A\u4F8B\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/6/14/172b1a30d36d9320~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
...
<p>\u4EE5\u4E0A\u4FBF\u662F\u8FD9\u9053\u9898\u7684\u52A8\u6001\u89C4\u5212\u89E3\u6CD5\u3002</p>
<h2 data-id="heading-6">\u4ECE\u9898\u89E3\u601D\u8DEF\u770B\u52A8\u6001\u89C4\u5212</h2>
...
<p>\u62FF\u8FD9\u9053\u9898\u7684\u5206\u6790\u8FC7\u7A0B\u6765\u8BF4\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/7/28/1739430a97f10d22~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
...
\u56E0\u6B64\uFF0C\u8FD9\u9053\u9898\u9002\u5408\u7528\u52A8\u6001\u89C4\u5212\u6765\u505A\u3002</p>
<h2 data-id="heading-7">\u52A8\u6001\u89C4\u5212\u95EE\u9898\u7684\u5206\u6790\u6280\u5DE7</h2>
...
<h2 data-id="heading-8">\u201C\u6700\u503C\u201D\u578B\u95EE\u9898\u5178\u8303\uFF1A\u5982\u4F55\u4F18\u96C5\u5730\u627E\u786C\u5E01</h2>
<blockquote>
...
<p>\u8F93\u51FA: -1</p>
<pre><code class="hljs language-!" lang="!">\u63D0\u793A\uFF1A\u6700\u503C\u95EE\u9898\u662F\u52A8\u6001\u89C4\u5212\u7684\u5E38\u89C1\u5BF9\u53E3\u9898\u578B\uFF0C\u89C1\u5230\u6700\u503C\u95EE\u9898\uFF0C\u5E94\u8BE5\u60F3\u5230\u52A8\u6001\u89C4\u5212
</code></pre>
...
<pre><code class="hljs language-js" lang="js">\u62FF\u8D70 c1
\u62FF\u8D70 c2
\u62FF\u8D70 c3
......
\u62FF\u8D70 cn
</code></pre>
<p>\u91CD\u590D\u5F80\u524D\u63A8\u5BFC\u8FD9\u4E2A\u201C\u62FF\u8D70\u201D\u7684\u8FC7\u7A0B\uFF0C\u6211\u4EEC\u53EF\u4EE5\u5F97\u5230\u4EE5\u4E0B\u7684\u6811\u5F62\u601D\u7EF4\u6A21\u578B\uFF1A</p>
<p><img src="https://p1-jj.byteimg.com/tos-cn-i-t2oaga2asx/gold-user-assets/2020/6/14/172b1a91f12139e5~tplv-t2oaga2asx-watermark.awebp" alt="" loading="lazy" class="medium-zoom-image"></p>
<p>\u5047\u5982\u7528 f(x\uFF09\u8868\u793A\u6BCF\u4E00\u4E2A\u603B\u989D\u6570\u5B57\u5BF9\u5E94\u7684\u6700\u5C11\u786C\u5E01\u6570\uFF0C\u90A3\u4E48\u6211\u4EEC\u53EF\u4EE5\u5F97\u5230\u4EE5\u4E0B\u7684\u5BF9\u5E94\u5173\u7CFB\uFF1A</p>
<pre><code class="hljs language-js" lang="js">f(<span class="hljs-number">36</span>) = <span class="hljs-built_in">Math</span>.min(f(<span class="hljs-number">36</span>-c1)+<span class="hljs-number">1</span>,f(<span class="hljs-number">36</span>-c2)+<span class="hljs-number">1</span>,f(<span class="hljs-number">36</span>-c3)+<span class="hljs-number">1.</span>.....f(<span class="hljs-number">36</span>-cn)+<span class="hljs-number">1</span>)
</code></pre>
...
<pre><code class="hljs language-js" lang="js">f[<span class="hljs-number">0</span>] = <span class="hljs-number">0</span>
</code></pre>
<p>\u73B0\u5728\uFF0C\u660E\u786E\u4E86\u72B6\u6001\u8F6C\u79FB\u65B9\u7A0B\uFF0C\u660E\u786E\u4E86\u5DF2\u77E5\u5B50\u95EE\u9898\u7684\u89E3\uFF0C\u6211\u4EEC\u6765\u5199\u4EE3\u7801\uFF1A</p>
<h3 data-id="heading-10">\u7F16\u7801\u5B9E\u73B0</h3>
<pre><code class="hljs language-js" lang="js"><span class="hljs-keyword">const</span> coinChange = <span class="hljs-function"><span class="hljs-keyword">function</span>(<span class="hljs-params">coins, amount</span>) </span>{
    ...
    <span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> i=<span class="hljs-number">1</span>;i&lt;=amount;i++) {
        ...
        <span class="hljs-keyword">for</span>(<span class="hljs-keyword">let</span> j=<span class="hljs-number">0</span>;j&lt;coins.length;j++) {
            ...
            <span class="hljs-keyword">if</span>(i-coins[j]&gt;=<span class="hljs-number">0</span>) {
    ...
    <span class="hljs-keyword">if</span>(f[amount]===<span class="hljs-literal">Infinity</span>) {
        <span class="hljs-keyword">return</span> -<span class="hljs-number">1</span>
    }
