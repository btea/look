...
<h3 data-id="heading-3">\u771F\u5B9E\u6392\u5E8F\u8FC7\u7A0B\u6F14\u793A</h3>
<p>\u4E0B\u9762\u6211\u4EEC\u57FA\u4E8E\u5F52\u5E76\u6392\u5E8F\u7684\u601D\u8DEF\uFF0C\u5C1D\u8BD5\u5BF9\u4EE5\u4E0B\u6570\u7EC4\u8FDB\u884C\u6392\u5E8F\uFF1A</p>
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">8</span>, <span class="hljs-number">7</span>, <span class="hljs-number">6</span>, <span class="hljs-number">5</span>, <span class="hljs-number">4</span>, <span class="hljs-number">3</span>, <span class="hljs-number">2</span>, <span class="hljs-number">1</span>]
</code></pre>
...
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">7</span>, <span class="hljs-number">8</span>,| <span class="hljs-number">5</span>, <span class="hljs-number">6</span>,| <span class="hljs-number">3</span>, <span class="hljs-number">4</span>,| <span class="hljs-number">1</span>, <span class="hljs-number">2</span>]
</code></pre>
<p>\u7EE7\u7EED\u5C06\u89C4\u6A21\u4E3A2\u7684\u6309\u7167\u6709\u5E8F\u539F\u5219\u5408\u5E76\u4E3A\u89C4\u6A21\u4E3A4\u7684\u5B50\u6570\u7EC4\uFF1A</p>
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">5</span>, <span class="hljs-number">6</span>, <span class="hljs-number">7</span>, <span class="hljs-number">8</span>,| <span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>, <span class="hljs-number">4</span>]  
</code></pre>
<p>\u6700\u540E\u5C06\u89C4\u6A21\u4E3A4\u7684\u5B50\u6570\u7EC4\u5408\u5E76\u4E3A\u89C4\u6A21\u4E3A8\u7684\u6570\u7EC4\uFF1A</p>
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">1</span>, <span class="hljs-number">2</span>, <span class="hljs-number">3</span>, <span class="hljs-number">4</span>, <span class="hljs-number">5</span>, <span class="hljs-number">6</span>, <span class="hljs-number">7</span>, <span class="hljs-number">8</span>]  
</code></pre>
<p>\u6574\u4E2A\u6570\u7EC4\u5C31\u5B8C\u5168\u6709\u5E8F\u4E86\u3002</p>
<h3 data-id="heading-4">\u7F16\u7801\u5B9E\u73B0</h3>
...
<pre><code class="hljs language-js" lang="js"><span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">mergeSort</span>(<span class="hljs-params">arr</span>) </span>{
...
<h3 data-id="heading-6">\u7F16\u7801\u590D\u76D8\u2014\u2014\u5F52\u5E76\u6392\u5E8F\u7684\u65F6\u95F4\u590D\u6742\u5EA6\u5206\u6790</h3>
<p>\u5F52\u5E76\u6392\u5E8F\u7684\u65F6\u95F4\u590D\u6742\u5EA6\u7684\u5206\u6790\uFF0C\u540C\u6837\u662F\u57FA\u4E8E\u5206\u6CBB\u6CD5\u3002</p>
<h4 data-id="heading-7">\u57FA\u4E8E\u6570\u5B66\u8BA1\u7B97\u7684\u5206\u6790</h4>
<p>\u6211\u4EEC\u5047\u8BBE\u89C4\u6A21\u4E3A n \u7684\u6570\u7EC4\u5BF9\u5E94\u7684\u6392\u5E8F\u7684\u65F6\u95F4\u590D\u6742\u5EA6\u662F\u4E00\u4E2A\u5173\u4E8E n \u7684\u51FD\u6570 F(n)\u3002\u90A3\u4E48\u5B83\u548C\u81EA\u5DF1\u7684\u4E24\u4E2A\u5B50\u6570\u7EC4\u4E4B\u95F4\u5C31\u6709\u5982\u4E0B\u5173\u7CFB\uFF1A</p>
<pre><code class="hljs language-js" lang="js">F(n) = F(n/<span class="hljs-number">2</span>) + F(n/<span class="hljs-number">2</span>) + \u5408\u5E76\u4E24\u4E2A\u6570\u7EC4\u7684\u65F6\u95F4
</code></pre>
<p>\u5408\u5E76\u4E24\u4E2A\u6570\u7EC4\u7684\u8FC7\u7A0B\u4E00\u5171\u8981\u5BF9 <code>n</code> \u4E2A\u5143\u7D20\u8FDB\u884C\u4E00\u8F6E\u5FAA\u73AF\uFF0C\u56E0\u6B64\u65F6\u95F4\u590D\u6742\u5EA6\u53EF\u4EE5\u76EE\u6D4B\u51FA\u6765\u662F O(n)\uFF0C\u4EE3\u5165\u4E0A\u9762\u516C\u5F0F\uFF1A</p>
<pre><code class="hljs language-js" lang="js">F(n) = F(n/<span class="hljs-number">2</span>) + F(n/<span class="hljs-number">2</span>) + O(n) = <span class="hljs-number">2</span>^<span class="hljs-number">1</span>*T(n/<span class="hljs-number">2</span>)+<span class="hljs-number">2</span>^<span class="hljs-number">0</span>*O(n)
</code></pre>
<p>\u7EE7\u7EED\u7EC6\u5206\uFF0C\u4E24\u4E2A\u5B50\u6570\u7EC4\u88AB\u5212\u5206\u4E3A\u56DB\u4E2A\u5B50\u6570\u7EC4\uFF0C\u4ECD\u7136\u9075\u5FAA\u4E0A\u9762\u516C\u5F0F\u6240\u63CF\u8FF0\u7684\u5173\u7CFB\u3002\u4EE3\u5165 n/4 \u540E\u53EF\u4EE5\u5F97\u5230\u56DB\u4E2A\u5B50\u6570\u7EC4\u548C\u5927\u6570\u7EC4\u4E4B\u95F4\u7684\u5173\u7CFB\uFF1A</p>
<pre><code class="hljs language-js" lang="js">F(n/<span class="hljs-number">2</span>) = <span class="hljs-number">2</span>*F(n/<span class="hljs-number">4</span>)+O(n)   
...
<pre><code class="hljs language-js" lang="js">F(n) = nF(<span class="hljs-number">1</span>) + O(nlog(n)) = O(nlog(n))
</code></pre>
<p>\u7EFC\u4E0A\u6240\u8FF0\uFF0C \u5F52\u5E76\u6392\u5E8F\u7684\u65F6\u95F4\u590D\u6742\u5EA6\u662F <code>O(nlog(n))</code>\u3002</p>
<h4 data-id="heading-8">\u57FA\u4E8E\u903B\u8F91\u7684\u5206\u6790</h4>
...
<pre><code class="hljs language-js" lang="js"> <span class="hljs-comment">// \u8BA1\u7B97\u5206\u5272\u70B9</span>
<span class="hljs-keyword">const</span> mid = <span class="hljs-built_in">Math</span>.floor(len / <span class="hljs-number">2</span>)    
<span class="hljs-comment">// \u9012\u5F52\u5206\u5272\u5DE6\u5B50\u6570\u7EC4\uFF0C\u7136\u540E\u5408\u5E76\u4E3A\u6709\u5E8F\u6570\u7EC4</span>
<span class="hljs-keyword">const</span> leftArr = mergeSort(arr.slice(<span class="hljs-number">0</span>, mid)) 
<span class="hljs-comment">// \u9012\u5F52\u5206\u5272\u53F3\u5B50\u6570\u7EC4\uFF0C\u7136\u540E\u5408\u5E76\u4E3A\u6709\u5E8F\u6570\u7EC4</span>
...
<pre><code class="hljs language-!" lang="!">\u4EE5\u4E0A\u4E24\u79CD\u65F6\u95F4\u590D\u6742\u5EA6\u7684\u8BA1\u7B97\u601D\u8DEF\uFF0C\u5927\u5BB6\u7406\u89E3\u5176\u4E2D\u4E00\u79CD\u5373\u53EF\uFF0C\u4E0D\u5FC5\u6B7B\u78D5\u3002
</code></pre>
<h2 data-id="heading-9">\u5FEB\u901F\u6392\u5E8F</h2>
...
<h3 data-id="heading-11">\u771F\u5B9E\u6392\u5E8F\u8FC7\u7A0B\u6F14\u793A</h3>
<p>\u9996\u5148\u8981\u505A\u7684\u4E8B\u60C5\u5C31\u9009\u53D6\u4E00\u4E2A\u57FA\u51C6\u503C\u3002\u57FA\u51C6\u503C\u7684\u9009\u62E9\u6709\u5F88\u591A\u65B9\u5F0F\uFF0C\u8FD9\u91CC\u6211\u4EEC\u9009\u53D6\u6570\u7EC4\u4E2D\u95F4\u7684\u503C\uFF1A</p>
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">5</span>, <span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">6</span>, <span class="hljs-number">2</span>, <span class="hljs-number">0</span>, <span class="hljs-number">7</span>]
 \u2191       \u57FA\u51C6      \u2191
</code></pre>
...
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">5</span>, <span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">0</span>, <span class="hljs-number">2</span>, <span class="hljs-number">6</span>, <span class="hljs-number">7</span>]
             \u2191 \u57FA\u51C6
             \u2191   
</code></pre>
...
<pre><code class="hljs language-js" lang="js">[<span class="hljs-number">5</span>, <span class="hljs-number">1</span>, <span class="hljs-number">3</span>, <span class="hljs-number">0</span>, <span class="hljs-number">2</span>]   
[<span class="hljs-number">6</span>, <span class="hljs-number">7</span>]
</code></pre>
<p>\u9488\u5BF9\u4E24\u4E2A\u5B50\u6570\u7EC4\uFF0C\u91CD\u590D\u6267\u884C\u4EE5\u4E0A\u64CD\u4F5C\uFF0C\u76F4\u5230\u6570\u7EC4\u5B8C\u5168\u6392\u5E8F\u4E3A\u6B62\u3002\u8FD9\u5C31\u662F\u5FEB\u901F\u6392\u5E8F\u7684\u6574\u4E2A\u8FC7\u7A0B\u3002</p>
<h3 data-id="heading-12">\u7F16\u7801\u5B9E\u73B0</h3>
<pre><code class="hljs language-js" lang="js"><span class="hljs-comment">// \u5FEB\u901F\u6392\u5E8F\u5165\u53E3</span>
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">quickSort</span>(<span class="hljs-params">arr, left = <span class="hljs-number">0</span>, right = arr.length - <span class="hljs-number">1</span></span>) </span>{
  ...
  <span class="hljs-keyword">if</span>(arr.length &gt; <span class="hljs-number">1</span>) {
      ...
      <span class="hljs-keyword">if</span>(left &lt; lineIndex-<span class="hljs-number">1</span>) {
      ...
      <span class="hljs-keyword">if</span>(lineIndex&lt;right) {
...
<span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">partition</span>(<span class="hljs-params">arr, left, right</span>) </span>{
  ...
  <span class="hljs-keyword">while</span>(i&lt;=j) {
      ...
      <span class="hljs-keyword">while</span>(arr[i] &lt; pivotValue) {
          i++
      }
      <span class="hljs-comment">// \u53F3\u6307\u9488\u6240\u6307\u5143\u7D20\u5927\u4E8E\u57FA\u51C6\u503C\uFF0C\u5219\u5DE6\u79FB\u53F3\u6307\u9488</span>
      <span class="hljs-keyword">while</span>(arr[j] &gt; pivotValue) {
          j--
      }
...
<h3 data-id="heading-13">\u7F16\u7801\u590D\u76D8\u2014\u2014\u5FEB\u901F\u6392\u5E8F\u7684\u65F6\u95F4\u590D\u6742\u5EA6\u5206\u6790</h3>
