...
<h3 data-id="heading-3">\u56FE\u7247\u52A0\u8F7D\u4F18\u5316</h3>
<ol>
...
<h2 data-id="heading-4">DNS \u9884\u89E3\u6790</h2>
<p>DNS \u89E3\u6790\u4E5F\u662F\u9700\u8981\u65F6\u95F4\u7684\uFF0C\u53EF\u4EE5\u901A\u8FC7\u9884\u89E3\u6790\u7684\u65B9\u5F0F\u6765\u9884\u5148\u83B7\u5F97\u57DF\u540D\u6240\u5BF9\u5E94\u7684 IP\u3002</p>
<pre><code lang="html" class=""><span>&lt;<span>link</span> <span>rel</span>=<span>"dns-prefetch"</span> <span>href</span>=<span>"//yuchengkai.cn"</span>&gt;</span>
</code></pre><h2 data-id="heading-5">\u8282\u6D41</h2>
<p>\u8003\u8651\u4E00\u4E2A\u573A\u666F\uFF0C\u6EDA\u52A8\u4E8B\u4EF6\u4E2D\u4F1A\u53D1\u8D77\u7F51\u7EDC\u8BF7\u6C42\uFF0C\u4F46\u662F\u6211\u4EEC\u5E76\u4E0D\u5E0C\u671B\u7528\u6237\u5728\u6EDA\u52A8\u8FC7\u7A0B\u4E2D\u4E00\u76F4\u53D1\u8D77\u8BF7\u6C42\uFF0C\u800C\u662F\u9694\u4E00\u6BB5\u65F6\u95F4\u53D1\u8D77\u4E00\u6B21\uFF0C\u5BF9\u4E8E\u8FD9\u79CD\u60C5\u51B5\u6211\u4EEC\u5C31\u53EF\u4EE5\u4F7F\u7528\u8282\u6D41\u3002</p>
<p>\u7406\u89E3\u4E86\u8282\u6D41\u7684\u7528\u9014\uFF0C\u6211\u4EEC\u5C31\u6765\u5B9E\u73B0\u4E0B\u8FD9\u4E2A\u51FD\u6570</p>
<pre><code lang="js" class=""><span>// func\u662F\u7528\u6237\u4F20\u5165\u9700\u8981\u9632\u6296\u7684\u51FD\u6570</span>
<span>// wait\u662F\u7B49\u5F85\u65F6\u95F4</span>
<span>const</span> throttle = <span>(<span>func, wait = <span>50</span></span>) =&gt;</span> {
  <span>// \u4E0A\u4E00\u6B21\u6267\u884C\u8BE5\u51FD\u6570\u7684\u65F6\u95F4</span>
  <span>let</span> lastTime = <span>0</span>
  <span>return</span> <span><span>function</span>(<span>...args</span>) </span>{
    <span>// \u5F53\u524D\u65F6\u95F4</span>
    <span>let</span> now = +<span>new</span> <span>Date</span>()
    <span>// \u5C06\u5F53\u524D\u65F6\u95F4\u548C\u4E0A\u4E00\u6B21\u6267\u884C\u51FD\u6570\u65F6\u95F4\u5BF9\u6BD4</span>
    <span>// \u5982\u679C\u5DEE\u503C\u5927\u4E8E\u8BBE\u7F6E\u7684\u7B49\u5F85\u65F6\u95F4\u5C31\u6267\u884C\u51FD\u6570</span>
    <span>if</span> (now - lastTime &gt; wait) {
      lastTime = now
      func.apply(<span>this</span>, args)
    }
  }
}

setInterval(
  throttle(<span><span>()</span> =&gt;</span> {
    <span>console</span>.log(<span>1</span>)
  }, <span>500</span>),
  <span>1</span>
)
</code></pre><h2 data-id="heading-6">\u9632\u6296</h2>
<p>\u8003\u8651\u4E00\u4E2A\u573A\u666F\uFF0C\u6709\u4E00\u4E2A\u6309\u94AE\u70B9\u51FB\u4F1A\u89E6\u53D1\u7F51\u7EDC\u8BF7\u6C42\uFF0C\u4F46\u662F\u6211\u4EEC\u5E76\u4E0D\u5E0C\u671B\u6BCF\u6B21\u70B9\u51FB\u90FD\u53D1\u8D77\u7F51\u7EDC\u8BF7\u6C42\uFF0C\u800C\u662F\u5F53\u7528\u6237\u70B9\u51FB\u6309\u94AE\u4E00\u6BB5\u65F6\u95F4\u540E\u6CA1\u6709\u518D\u6B21\u70B9\u51FB\u7684\u60C5\u51B5\u624D\u53BB\u53D1\u8D77\u7F51\u7EDC\u8BF7\u6C42\uFF0C\u5BF9\u4E8E\u8FD9\u79CD\u60C5\u51B5\u6211\u4EEC\u5C31\u53EF\u4EE5\u4F7F\u7528\u9632\u6296\u3002</p>
<p>\u7406\u89E3\u4E86\u9632\u6296\u7684\u7528\u9014\uFF0C\u6211\u4EEC\u5C31\u6765\u5B9E\u73B0\u4E0B\u8FD9\u4E2A\u51FD\u6570</p>
<pre><code lang="js" class=""><span>// func\u662F\u7528\u6237\u4F20\u5165\u9700\u8981\u9632\u6296\u7684\u51FD\u6570</span>
<span>// wait\u662F\u7B49\u5F85\u65F6\u95F4</span>
<span>const</span> debounce = <span>(<span>func, wait = <span>50</span></span>) =&gt;</span> {
  <span>// \u7F13\u5B58\u4E00\u4E2A\u5B9A\u65F6\u5668id</span>
  <span>let</span> timer = <span>0</span>
  <span>// \u8FD9\u91CC\u8FD4\u56DE\u7684\u51FD\u6570\u662F\u6BCF\u6B21\u7528\u6237\u5B9E\u9645\u8C03\u7528\u7684\u9632\u6296\u51FD\u6570</span>
  <span>// \u5982\u679C\u5DF2\u7ECF\u8BBE\u5B9A\u8FC7\u5B9A\u65F6\u5668\u4E86\u5C31\u6E05\u7A7A\u4E0A\u4E00\u6B21\u7684\u5B9A\u65F6\u5668</span>
  <span>// \u5F00\u59CB\u4E00\u4E2A\u65B0\u7684\u5B9A\u65F6\u5668\uFF0C\u5EF6\u8FDF\u6267\u884C\u7528\u6237\u4F20\u5165\u7684\u65B9\u6CD5</span>
  <span>return</span> <span><span>function</span>(<span>...args</span>) </span>{
    <span>if</span> (timer) clearTimeout(timer)
    timer = setTimeout(<span><span>()</span> =&gt;</span> {
      func.apply(<span>this</span>, args)
    }, wait)
  }
}
</code></pre><h2 data-id="heading-7">\u9884\u52A0\u8F7D</h2>
...
<pre><code lang="html" class=""><span>&lt;<span>link</span> <span>rel</span>=<span>"preload"</span> <span>href</span>=<span>"http://example.com"</span>&gt;</span>
</code></pre><p>\u9884\u52A0\u8F7D\u53EF\u4EE5\u4E00\u5B9A\u7A0B\u5EA6\u4E0A\u964D\u4F4E\u9996\u5C4F\u7684\u52A0\u8F7D\u65F6\u95F4\uFF0C\u56E0\u4E3A\u53EF\u4EE5\u5C06\u4E00\u4E9B\u4E0D\u5F71\u54CD\u9996\u5C4F\u4F46\u91CD\u8981\u7684\u6587\u4EF6\u5EF6\u540E\u52A0\u8F7D\uFF0C\u552F\u4E00\u7F3A\u70B9\u5C31\u662F\u517C\u5BB9\u6027\u4E0D\u597D\u3002</p>
<h2 data-id="heading-8">\u9884\u6E32\u67D3</h2>
<p>\u53EF\u4EE5\u901A\u8FC7\u9884\u6E32\u67D3\u5C06\u4E0B\u8F7D\u7684\u6587\u4EF6\u9884\u5148\u5728\u540E\u53F0\u6E32\u67D3\uFF0C\u53EF\u4EE5\u4F7F\u7528\u4EE5\u4E0B\u4EE3\u7801\u5F00\u542F\u9884\u6E32\u67D3</p>
<pre><code lang="html" class=""><span>&lt;<span>link</span> <span>rel</span>=<span>"prerender"</span> <span>href</span>=<span>"http://example.com"</span>&gt;</span> 
</code></pre><p>\u9884\u6E32\u67D3\u867D\u7136\u53EF\u4EE5\u63D0\u9AD8\u9875\u9762\u7684\u52A0\u8F7D\u901F\u5EA6\uFF0C\u4F46\u662F\u8981\u786E\u4FDD\u8BE5\u9875\u9762\u5927\u6982\u7387\u4F1A\u88AB\u7528\u6237\u5728\u4E4B\u540E\u6253\u5F00\uFF0C\u5426\u5219\u5C31\u662F\u767D\u767D\u6D6A\u8D39\u8D44\u6E90\u53BB\u6E32\u67D3\u3002</p>
<h2 data-id="heading-9">\u61D2\u6267\u884C</h2>
<p>\u61D2\u6267\u884C\u5C31\u662F\u5C06\u67D0\u4E9B\u903B\u8F91\u5EF6\u8FDF\u5230\u4F7F\u7528\u65F6\u518D\u8BA1\u7B97\u3002\u8BE5\u6280\u672F\u53EF\u4EE5\u7528\u4E8E\u9996\u5C4F\u4F18\u5316\uFF0C\u5BF9\u4E8E\u67D0\u4E9B\u8017\u65F6\u903B\u8F91\u5E76\u4E0D\u9700\u8981\u5728\u9996\u5C4F\u5C31\u4F7F\u7528\u7684\uFF0C\u5C31\u53EF\u4EE5\u4F7F\u7528\u61D2\u6267\u884C\u3002\u61D2\u6267\u884C\u9700\u8981\u5524\u9192\uFF0C\u4E00\u822C\u53EF\u4EE5\u901A\u8FC7\u5B9A\u65F6\u5668\u6216\u8005\u4E8B\u4EF6\u7684\u8C03\u7528\u6765\u5524\u9192\u3002</p>
<h2 data-id="heading-10">\u61D2\u52A0\u8F7D</h2>
